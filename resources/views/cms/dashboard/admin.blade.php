                                ...
                                <table id="projects-tbl" class="table ItemsCheckboxSec">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="pe-0">
                                                <div class="avatar-list avatar-list-stacked">
                                                    <img src="{{ url('cms') }}/images/contacts/pic1.jpg"
                                                        class="avatar rounded-circle" alt="">
                                                    <img src="{{ url('cms') }}/images/contacts/pic555.jpg"
                                                        class="avatar rounded-circle" alt="">
                                                    <img src="{{ url('cms') }}/images/contacts/pic666.jpg"
                                                        class="avatar rounded-circle" alt="">
                                                </div>
                                            </td>
                                            <td class="pe-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="pe-0">
                                                <div class="avatar-list avatar-list-stacked">
                                                    <img src="{{ url('cms') }}/images/contacts/pic1.jpg"
                                                        class="avatar rounded-circle" alt="">
                                                    <img src="{{ url('cms') }}/images/contacts/pic777.jpg"
                                                        class="avatar rounded-circle" alt="">
                                                    <img src="{{ url('cms') }}/images/contacts/pic666.jpg"
                                                        class="avatar rounded-circle" alt="">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('cms') }}/images/contacts/pic888.jpg"
                                                        class="avatar rounded-circle" alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('cms') }}/images/contacts/pic999.jpg"
                                                        class="avatar rounded-circle" alt="">
                                                    <p class="mb-0 ms-2">Elijah James</p>
                                                </div>
                                            </td>
                                ...
                                <div class="col-xl-4 active-country dz-scroll">
                                    <div class="">
                                        <div class="country-list">
                                            <img src="{{ url('cms') }}/images/country/india.png" alt="">
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="country-list">
                                            <img src="{{ url('cms') }}/images/country/canada.png" alt="">
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="country-list">
                                            <img src="{{ url('cms') }}/images/country/russia.png" alt="">
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="country-list">
                                            <img src="{{ url('cms') }}/images/country/uk.png" alt="">
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="country-list">
                                            <img src="{{ url('cms') }}/images/country/aus.png" alt="">
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="country-list">
                                            <img src="{{ url('cms') }}/images/country/usa.png" alt="">
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="country-list">
                                            <img src="{{ url('cms') }}/images/country/pak.png" alt="">
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="country-list">
                                            <img src="{{ url('cms') }}/images/country/germany.png" alt="">
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="country-list">
                                            <img src="{{ url('cms') }}/images/country/uae.png" alt="">
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="country-list">
                                            <img src="{{ url('cms') }}/images/country/china.png" alt="">
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                ...
                                <table id="product-tbl" class="table ">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d1.jpg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d2.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox24" required="">
                                                    <label class="form-check-label" for="customCheckBox24"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d3.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox25" required="">
                                                    <label class="form-check-label" for="customCheckBox25"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d4.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox26" required="">
                                                    <label class="form-check-label" for="customCheckBox26"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d5.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox27" required="">
                                                    <label class="form-check-label" for="customCheckBox27"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d6.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox28" required="">
                                                    <label class="form-check-label" for="customCheckBox28"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d7.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox29" required="">
                                                    <label class="form-check-label" for="customCheckBox29"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d8.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox30" required="">
                                                    <label class="form-check-label" for="customCheckBox30"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d14.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox31" required="">
                                                    <label class="form-check-label" for="customCheckBox31"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d13.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox32" required="">
                                                    <label class="form-check-label" for="customCheckBox32"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d9.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d10.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox34" required="">
                                                    <label class="form-check-label" for="customCheckBox34"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d11.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="customCheckBox35" required="">
                                                    <label class="form-check-label" for="customCheckBox35"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="products">
                                                    <img src="{{ url('cms') }}/images/contacts/d12.jpg"
                                                        class="avatar avatar-md" alt="">
                                                    <div>
