...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 May 2023 11:13:56 GMT -->
...
<head>
    ...
    <link href="{{ url('cms') }}/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
                                                ...
                                                <div class="tab-content w-100" id="nav-tabContent">
                                                    <div class="tab-pane fade show active" id="nav-personal"
                                                        ...
                                                        <form action="{{ route('adminLogin') }}" method="POST"
                                                            ...
                                                            <p>Enter your Name address and your password. </p>
                                                        ...
                                                        <div class="text-center bottom">
                                                            <a href="{{ route('adminRegisterPage') }}"
                                                                class="btn btn-primary">Creat Account</a>
...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 May 2023 11:13:59 GMT -->
