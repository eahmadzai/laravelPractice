    ...
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a src="{{ url('cms') }}/{{ url('cms') }}/javascript:void(0)">
                ...
                <li class="breadcrumb-item active"><a
                        src="{{ url('cms') }}/{{ url('cms') }}/javascript:void(0)">Blog</a></li>
            </ol>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-md-3 col-6">
                    <div class="card  blog-card">
                        <div class="card-body text-center">
                            <img src="{{ url('cms') }}/images/books.png" alt="">
                            <h4>Education</h4>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-3 col-6">
                    <div class="card  blog-card">
                        <div class="card-body text-center">
                            <img src="{{ url('cms') }}/images/news.png" alt="">
                            <h4>News</h4>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-3 col-6">
                    <div class="card blog-card ">
                        <div class="card-body text-center">
                            <img src="{{ url('cms') }}/images/heart.png" alt="">
                            <h4>Ranking</h4>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-3 col-6">
                    <div class="card  blog-card">
                        <div class="card-body text-center">
                            <img src="{{ url('cms') }}/images/file.png" alt="">
                            <h4>File Manager</h4>
                        </div>
                    </div>
                </div>
                <div class="col-xl-12">
                    <dov class="card">
                        <div class="card-header border-0">
                            ...
                            <a src="{{ url('cms') }}/{{ url('cms') }}/javascript:void(0)"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12">
                                    <div class="blog-post">
                                        ...
                                        <div class="post-1">
                                            <img src="{{ url('cms') }}/images/profile/friends/f3.jpg"
                                                class="avatar rounded-circle me-2 custome-avatar" alt="">
                                            <div class="post-data">
                                                <span class="badge badge-warning border-0 badge-sm">MARKTING</span>
                                                <h4>Debugging is like being a detective in a crime movie where you're also
                                                    the murderer.</h4>
                                                <div>
                                                    <img src="{{ url('cms') }}/images/contacts/pic1.jpg"
                                                        class="avatar rounded-circle me-2 small-post" alt="">
                                        ...
                                        <div class="post-1">
                                            <img src="{{ url('cms') }}/images/profile/friends/f4.jpg"
                                                class="avatar rounded-circle me-2 custome-avatar" alt="">
                                            <div class="post-data">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="blog-img">
                                        <img src="{{ url('cms') }}/images/blog/professional2.jpg" alt=""
                                            class="blk-img2">
                                        <div class="blog-text">
                                            <h2>This quote highlights the importance of writing clear.</h2>
                                            <img src="{{ url('cms') }}/images/contacts/pic1.jpg"
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="seconday-post">
                                                <img src="{{ url('cms') }}/images/blog/s1.jpg">
                                                <div class="post-1">
                                                    <div class="post-data">
                                                        <span class="badge badge-warning border-0 badge-sm">MARKTING</span>
                                                        <h4>Debugging is like being a detective in a crime movie where
                                                            you're also the murderer.</h4>
                                                        <div>
                                                            <img src="{{ url('cms') }}/images/contacts/pic1.jpg"
                                                                class="avatar rounded-circle me-2 small-post"
                                                                alt="">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="seconday-post">
                                                <img src="{{ url('cms') }}/images/blog/s2.jpg">
                                                <div class="post-1">
                                                    <div class="post-data">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="seconday-post">
                                                <img src="{{ url('cms') }}/images/blog/s3.jpg">
                                                <div class="post-1">
                                                    <div class="post-data">
                                                        <span
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="post-1">
                                            <div class="post-data">
                                                ...
                                                <span>
                                                    ...
                                                    industry. Lorem Ipsum the industry's standard dummy text ever since the
                                    ...
                                    <div class="third-post">
                                        <img src="{{ url('cms') }}/images/blog/s4.jpg">
                                        <div class="post-1">
                                            <div class="post-data">
                                    ...
                                    <div class="third-post">
                                        <img src="{{ url('cms') }}/images/blog/s5.jpg">
                                        <div class="post-1">
                                            <div class="post-data">
                                    ...
                                    <div class="third-post">
                                        <img src="{{ url('cms') }}/images/blog/s6.jpg">
                                        <div class="post-1">
                                            <div class="post-data">
                ...
                <div class="col-xl-3 col-lg-5">
                    ...
                    <div class="recent-post">
                        <div class="blog-img style-1">
                            <img src="{{ url('cms') }}/images/blog/professional.jpg" alt="" class="blk-img">
                            <div class="blog-text">
                    ...
                    <div class="mb-4">
                        <ul class="c-social">
                            <li><a src="{{ url('cms') }}/{{ url('cms') }}/javascript:void(0);"
                                    class="bg-facebook"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li><a src="{{ url('cms') }}/{{ url('cms') }}/javascript:void(0);"
                                    class="bg-whatsapp"><i class="fa-brands fa-whatsapp"></i></a></li>
                            <li><a src="{{ url('cms') }}/{{ url('cms') }}/javascript:void(0);"
                                    class="bg-linkedin"><i class="fa-brands fa-linkedin-in"></i></a></li>
                            <li><a src="{{ url('cms') }}/{{ url('cms') }}/javascript:void(0);" class="bg-skype"><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="notify-data">
                                ...
                                <form>
                                    ...
                                    <span class="text-start mt-3 d-block text-danger">* We promise that we don't spam !
                                    </span>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="recent-post">
                        ...
                        <div class="third-post style-2">
                            <img src="{{ url('cms') }}/images/contacts/pic1.jpg"
                                class="avatar  rounded-circle me-2 av-post" alt="">
                            <div class="post-1">
                                <div class="post-data">
