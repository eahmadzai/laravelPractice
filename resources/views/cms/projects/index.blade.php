                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card box-hover">
                        ...
                        <div class="card-body">
                            ...
                            <p class="my-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                            ...
                            <div>
                                ...
                                <div class="avatar-list avatar-list-stacked">
                                    ...
                                    <img src="{{ url('cms') }}/images/contacts/pic555.jpg"
                                        class="avatar rounded-circle" alt="">
                                    <img src="{{ url('cms') }}/images/contacts/pic1.jpg" class="avatar rounded-circle"
                                        alt="">
                                    <img src="{{ url('cms') }}/images/contacts/pic555.jpg"
                                        class="avatar rounded-circle" alt="">
                                    <img src="{{ url('cms') }}/images/contacts/pic666.jpg"
                            ...
                            <div class="progress mt-4">
                                <div class="progress-bar bg-purple" style="width:60%; height:5px; border-radius:4px;"
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card box-hover">
                        ...
                        <div class="card-body">
                            ...
                            <div class="progress mt-4">
                                <div class="progress-bar bg-danger" style="width:60%; height:5px; border-radius:4px;"
                                    role="progressbar"></div>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between flex-wrap">
