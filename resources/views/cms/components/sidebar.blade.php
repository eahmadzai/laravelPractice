...
<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            <li class="menu-title">Car Clean</li>
            <li><a class= "" href="{{ route('adminIndex') }}" aria-expanded="false">
                    <div class="menu-icon">
            ...
            <li><a href="{{ route('service.index') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <li><a href="{{ route('providing.index') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <span class="nav-text">Providing</span>
                </a>
            </li>
            <li><a href="{{ route('HrIndex') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <li><a href="{{ route('financeIndex') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a class="" href="{{ route('taskIndex') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <li><a href="{{ route('performanceIndex') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <li><a href="{{ route('projectsIndex') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a href="{{ route('reportIndex') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                stroke="#888888" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M13.2688 2.52084V5.18742C13.2688 6.48909 14.3211 7.54417 15.6228 7.54784H18.1482"
                                stroke="#888888" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <li><a href="{{ route('clientsIndex') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <li><a href="{{ route('blogIndex') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path d="M14.4751 2.75V5.659C14.4751 7.079 15.6231 8.23 17.0431 8.234H19.7981"
                                stroke="#888888" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M14.2882 15.3585H8.88818" stroke="#888888" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M12.2432 11.606H8.88721" stroke="#888888" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Users Manager<span
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="app-profile-2.html">Profile 2 <span
                                        class="badge badge-danger badge-xs ms-1">NEW</span></a></li>
                            <li><a href="edit-profile.html">Edit Profile</a></li>
                            <li><a href="post-details.html">Post Details</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Customer Manager<span
                                class="badge badge-danger badge-xs ms-1">NEW</span></a>
                        <ul aria-expanded="false">
                    ...
                    <li><a href="contacts.html">Contacts <span class="badge badge-danger badge-xs ms-1">NEW</span></a>
                    </li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li class="extra-menu-li">
                        ...
                        <a class="btn show-more-btn border-0" data-bs-toggle="collapse" href="#collapseExample"
